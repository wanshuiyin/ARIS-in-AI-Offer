...
CATALOG = [
    ...
    T("image_generation_systems_tutorial", "gensys", "图像生成系统", "Image Generation Systems", "LDM · SD · SDXL · SD3 · FLUX · ControlNet · MMDiT", 25, ("dit.py", "mmdit_block.py", "toy_mmdit_t2i_pipeline.py")),
