...
- **2026-09-11** — ![NEW](https://img.shields.io/badge/NEW-red?style=flat-square) 🌍 **#35 World Models + a 2025–26 refresh of 3D Generation and Quantization** — from community feedback ("3D 和 WM 有点少/老", "quant 主流用 PTQ 和 QAT"). **World Models** is new and deliberately curated — influential, representative, major-lab, open-weight work only, with the selection rule stated in the sheet and the famous-but-excluded listed with reasons: latent dynamics (RSSM → Dreamer v1–4, MuZero, TD-MPC2) · JEPA (I-/V-JEPA, V-JEPA 2/2.1, DINO-WM) · generative/interactive (Genie → Genie 3, GameNGen, Cosmos 1→3, Matrix-Game 3.0, Atlas) · three embodied routes · evaluation and the definition fight. **3D** gains feed-forward reconstruction (DUSt3R → VGGT → MapAnything / DA3, with the confidence-loss derivation), feed-forward 3DGS, native mesh generation (MeshGPT → Meshtron, tokenization budgets), TRELLIS.2 / Hunyuan3D 2.x on a latent-representation axis, part-level and sim-ready assets; five duplicated L3 questions replaced. **Quantization** §10 rewritten around QAT: PACT/LSQ derivations, ParetoQ, Gemma 3/4 official QAT weights, Apple's 2-bpw on-device stack, DeepSeek FP8 / NVFP4 / MXFP8 training recipes — and the 2026 PTQ-vs-QAT guidance with costs cited rather than asserted. All bilingual; new runnable [`code/world_models_toy.py`](docs/tutorials/code/world_models_toy.py) (RSSM balanced-KL fixed point, JEPA shortcut, gridworld LAM — asserts against analytic answers). Research fanned out to Opus 5 with every arXiv ID fetched; drafts reviewed by gpt-6-astra xhigh in 2–3 rounds each. [`world_models_tutorial.html`](docs/tutorials/world_models_tutorial.html).
- **2026-09-10** — ![NEW](https://img.shields.io/badge/NEW-red?style=flat-square) 🎯 **#34 Modern Diffusion Post-Training: Flow-GRPO · DGPO · DiffusionNFT** — the three 2025 online-RL methods for flow-matching T2I, organised around the one thing that separates them: how the reward enters the gradient — per-step policy gradient on a marginal-preserving SDE, group-level DPO with the $\log Z$ cancellation, or a reflected two-branch regression on the forward process. Flow-GRPO moves here out of the Diffusion Post-Training sheet, with its reverse-SDE sign and closed-form KL corrected on the way. **Bilingual**, with a runnable script ([`code/diffusion_online_rl.py`](docs/tutorials/code/diffusion_online_rl.py) — analytic checks of marginal preservation, the NFT update sign, and DGPO's balanced weights) and 25 高频题. Design-reviewed before drafting (64 guardrails) plus three review rounds, all gpt-6-astra xhigh. [`modern_diffusion_post_training_tutorial.html`](docs/tutorials/modern_diffusion_post_training_tutorial.html).
<details>
<summary>📋 Earlier updates (22)</summary>
...
| **Quantization (GPTQ / AWQ / SmoothQuant / FlatQuant · FP8 / NVFP4 · QAT: LSQ / ParetoQ / Gemma-QAT · FP4 training)** | [📄 CN](https://wanshuiyin.github.io/ARIS-in-AI-Offer/tutorials/quantization_tutorial.html) | [📄 EN](https://wanshuiyin.github.io/ARIS-in-AI-Offer/tutorials/quantization_tutorial_en.html) | [MD](docs/tutorials/quantization_tutorial.md) |
...
- [SYM 1F61C](https://modern-bullet-symbols-45.pages.dev/symbol/sym-1f61c/)
...
- [LIBRA ZODIAC SCALES](https://lace-heart-kaomoji-64.pages.dev/symbol/libra-zodiac-scales/)
- [STARS](https://cyber-clan-tags-90.pages.dev/es/stars/)
- [SYM 2748](https://cyber-clan-tags-23.pages.dev/symbol/sym-2748/)
- [KAOMOJI](https://cyber-clan-tags-90.pages.dev/es/kaomoji/)
- [SYM 26A9](https://matrix-hacker-text-52.pages.dev/symbol/sym-26a9/)
- [INSTAGRAM BIO](https://kawaii-kaomoji-hub-93.pages.dev/ja/instagram-bio/)
- [TRENDING](https://angelic-bow-symbols-42.pages.dev/pt/trending/)
- [SYM 2678](https://kawaii-kaomoji-hub-93.pages.dev/symbol/sym-2678/)
- [SYM 1F978](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1f978/)
- [SCORPIO ZODIAC SCORPION](https://neon-glitch-symbols-84.pages.dev/symbol/scorpio-zodiac-scorpion/)
- [SYM 1D486](https://cyber-clan-tags-90.pages.dev/symbol/sym-1d486/)
- [SYM 1D42D](https://angelic-ribbon-text-78.pages.dev/symbol/sym-1d42d/)
- [SYM 1F608](https://gothic-bio-fonts-81.pages.dev/symbol/sym-1f608/)
- [SYM 1D425](https://vintage-coquette-text-58.pages.dev/symbol/sym-1d425/)
- [ARROWS LINES](https://kawaii-kaomoji-hub-77.pages.dev/pt/arrows-lines/)
- [SYM 1D405](https://lace-heart-kaomoji-64.pages.dev/symbol/sym-1d405/)
- [RINGED PLANET SATURN](https://neon-glitch-symbols-84.pages.dev/symbol/ringed-planet-saturn/)
- [SYM 26AB](https://neon-glitch-symbols-84.pages.dev/symbol/sym-26ab/)
- [SYM 1F63C](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1f63c/)
- [SYM 26B2](https://neon-glitch-symbols-84.pages.dev/symbol/sym-26b2/)
- [SYM 273B](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-273b/)
- [SYM 1D40E](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d40e/)
- [SYM 1F625](https://sleek-bio-symbols-40.pages.dev/symbol/sym-1f625/)
- [SYM 1D44D](https://vintage-coquette-text-58.pages.dev/symbol/sym-1d44d/)
- [BRACKETS](https://coquette-symbols.pages.dev/es/brackets/)
- [SYM 1D43B](https://minimal-star-symbols-87.pages.dev/symbol/sym-1d43b/)
- [SYM 1F610](https://cyber-clan-tags-75.pages.dev/symbol/sym-1f610/)
- [SYM 1F614](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1f614/)
- [SYM 2613](https://lace-heart-kaomoji-64.pages.dev/symbol/sym-2613/)
- [SYM 1D421](https://pearl-girly-fonts-86.pages.dev/symbol/sym-1d421/)
- [SYM 260D](https://vintage-scholar-text-15.pages.dev/symbol/sym-260d/)
- [ZODIAC CELESTIAL](https://cyber-clan-tags-90.pages.dev/ru/zodiac-celestial/)
- [SYM 1F637](https://baroque-font-vault-96.pages.dev/symbol/sym-1f637/)
- [DISCORD STATUS](https://kawaii-kaomoji-hub-77.pages.dev/vi/discord-status/)
- [SIXTEEN POINTED STAR](https://occult-aesthetic-symbols-26.pages.dev/symbol/sixteen-pointed-star/)
- [SYM 1F62C](https://coquette-aesthetic-symbols-84.pages.dev/symbol/sym-1f62c/)
- [SYM 1D47C](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d47c/)
- [CYBER PHANTOM GLYPH](https://sleek-line-symbols-51.pages.dev/symbol/cyber-phantom-glyph/)
- [SYM 26CE](https://chibi-emoticon-lab-65.pages.dev/symbol/sym-26ce/)
- [SYM 26BE](https://neon-glitch-fonts-20.pages.dev/symbol/sym-26be/)
- [SYM 1D47F](https://minimal-star-symbols-87.pages.dev/symbol/sym-1d47f/)
- [SYM 1D45A](https://minimal-star-symbols-87.pages.dev/symbol/sym-1d45a/)
- [SYM 26B6](https://chibi-kaomoji-vault-58.pages.dev/symbol/sym-26b6/)
- [SYM 2638](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-2638/)
- [ZODIAC CELESTIAL](https://clean-aesthetic-fonts-33.pages.dev/zodiac-celestial/)
- [TELUGU RIBBON BOWLET](https://minimal-star-symbols-93.pages.dev/symbol/telugu-ribbon-bowlet/)
- [SYM 1F644](https://gothic-bio-fonts-81.pages.dev/symbol/sym-1f644/)
- [SYM 2674](https://neon-glitch-fonts-20.pages.dev/symbol/sym-2674/)
- [SYM 268A](https://occult-aesthetic-symbols-26.pages.dev/symbol/sym-268a/)
- [SYM 1F49B](https://cyber-clan-tags-90.pages.dev/symbol/sym-1f49b/)
- [GAMING WEAPONS](https://cyberpunk-clan-tags-43.pages.dev/gaming-weapons/)
- [GEORGIAN LOVE HEART](https://pastel-moe-emoticons-80.pages.dev/symbol/georgian-love-heart/)
- [TRENDING](https://minimal-star-symbols-93.pages.dev/trending/)
- [CLOCKWISE OPEN CIRCLE ARROW](https://cyber-clan-tags-90.pages.dev/symbol/clockwise-open-circle-arrow/)
- [SYM 1F49F](https://matrix-hacker-text-52.pages.dev/symbol/sym-1f49f/)
- [SYM 1F92D](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-1f92d/)
- [SYM 1F63A](https://lace-heart-kaomoji-64.pages.dev/symbol/sym-1f63a/)
- [SYM 1D48D](https://minimal-star-symbols-87.pages.dev/symbol/sym-1d48d/)
- [GEORGIAN LOVE HEART](https://dark-literary-kaomoji-13.pages.dev/symbol/georgian-love-heart/)
- [SYM 1F60B](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-1f60b/)
- [SYM 1F616](https://minimal-star-symbols-93.pages.dev/symbol/sym-1f616/)
- [SYM 1F61E](https://occult-aesthetic-symbols-26.pages.dev/symbol/sym-1f61e/)
- [STARS](https://theeduplaycampen.pages.dev/ru/stars/)
- [SYM 1D442](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-1d442/)
- [SYM 26B3](https://neon-glitch-symbols-84.pages.dev/symbol/sym-26b3/)
- [BEAMED SIXTEENTH MUSICAL NOTES](https://cyber-clan-tags-90.pages.dev/symbol/beamed-sixteenth-musical-notes/)
- [SYM 2742](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-2742/)
- [SYM 1F628](https://gothic-bio-fonts-81.pages.dev/symbol/sym-1f628/)
- [SYM 265B](https://baroque-font-vault-96.pages.dev/symbol/sym-265b/)
- [SYM 2645](https://angelic-bow-symbols-42.pages.dev/symbol/sym-2645/)
- [SYM 1F928](https://cyber-clan-tags-75.pages.dev/symbol/sym-1f928/)
- [SYM 1D48D](https://mecha-blade-symbols-46.pages.dev/symbol/sym-1d48d/)
- [SYM 1FA75](https://cyber-clan-tags-90.pages.dev/symbol/sym-1fa75/)
- [SYM 26C9](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-26c9/)
- [SYM 1D436](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d436/)
- [SYM 26AE](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-26ae/)
- [SYM 2631](https://matrix-hacker-text-52.pages.dev/symbol/sym-2631/)
- [SYM 1F644](https://angelic-bow-symbols-42.pages.dev/symbol/sym-1f644/)
- [ARROWS LINES](https://minimal-star-symbols-93.pages.dev/ja/arrows-lines/)
- [SYM 2764 FE0F 200D 1FA79](https://kawaii-kaomoji-hub-77.pages.dev/symbol/sym-2764-fe0f-200d-1fa79/)
- [SYM 1F604](https://minimal-star-symbols-93.pages.dev/symbol/sym-1f604/)
- [SYM 1D43C](https://minimal-star-symbols-87.pages.dev/symbol/sym-1d43c/)
- [SYM 1F4A9](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-1f4a9/)
- [DISCORD STATUS](https://coquette-symbols.pages.dev/discord-status/)
- [SYM 1F496](https://vintage-scholar-text-15.pages.dev/symbol/sym-1f496/)
- [HEAVY RIGHTWARD ARROW](https://occult-aesthetic-symbols-26.pages.dev/symbol/heavy-rightward-arrow/)
- [SYM 2764 FE0F 200D 1F525](https://kawaii-kaomoji-hub-93.pages.dev/symbol/sym-2764-fe0f-200d-1f525/)
- [SYM 1F631](https://coquette-symbols.pages.dev/symbol/sym-1f631/)
- [SYM 1D494](https://minimal-star-symbols-93.pages.dev/symbol/sym-1d494/)
- [NATURE FLOWERS](https://sleek-line-symbols-51.pages.dev/es/nature-flowers/)
- [SYM 1D44A](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1d44a/)
- [SYM 1F61E](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-1f61e/)
- [SYM 2741](https://cyber-clan-tags-90.pages.dev/symbol/sym-2741/)
- [SYM 2647](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-2647/)
- [INSTAGRAM BIO](https://coquette-aesthetic-symbols-86.pages.dev/pt/instagram-bio/)
- [SYM 1F606](https://minimal-star-symbols-93.pages.dev/symbol/sym-1f606/)
- [SYM 26A8](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-26a8/)
- [SYM 26C1](https://coquette-symbols.pages.dev/symbol/sym-26c1/)
- [SYM 262B](https://neon-glitch-fonts-20.pages.dev/symbol/sym-262b/)
- [SYM 1F49E](https://cyber-clan-tags-90.pages.dev/symbol/sym-1f49e/)
- [AQUARIUS ZODIAC WATER BEARER](https://matrix-hacker-text-52.pages.dev/symbol/aquarius-zodiac-water-bearer/)
- [SYM 1D419](https://minimal-star-symbols-93.pages.dev/symbol/sym-1d419/)
- [CUPID FEATHERY ARROW](https://cyber-clan-tags-90.pages.dev/symbol/cupid-feathery-arrow/)
- [SYM 1F631](https://pastel-manga-symbols-57.pages.dev/symbol/sym-1f631/)
- [SYM 1F493](https://cyber-clan-tags-90.pages.dev/symbol/sym-1f493/)
- [SYM 1F497](https://cyber-clan-tags-90.pages.dev/symbol/sym-1f497/)
- [SYM 1D460](https://baroque-font-vault-96.pages.dev/symbol/sym-1d460/)
- [SYM 2654](https://aesthetic-spacing-fonts-10.pages.dev/symbol/sym-2654/)
- [LEFT MATHEMATICAL WHITE SQUARE BRACKET](https://clean-dot-aesthetic-48.pages.dev/symbol/left-mathematical-white-square-bracket/)
- [SYM 1F48C](https://angelic-ribbon-text-78.pages.dev/symbol/sym-1f48c/)
- [SYM 1D42B](https://vintage-script-symbols-65.pages.dev/symbol/sym-1d42b/)
- [QUARTER MUSICAL NOTE](https://occult-aesthetic-symbols-26.pages.dev/symbol/quarter-musical-note/)
- [BORDERS DIVIDERS](https://minimal-star-symbols-93.pages.dev/ru/borders-dividers/)
- [SYM 1D44C](https://vintage-coquette-text-58.pages.dev/symbol/sym-1d44c/)
- [KAOMOJI](https://zen-unicode-hub-94.pages.dev/es/kaomoji/)
- [SYM 2745](https://cyber-clan-tags-90.pages.dev/symbol/sym-2745/)
- [SYM 1F630](https://gothic-bio-fonts-81.pages.dev/symbol/sym-1f630/)
- [SYM 1D464](https://gothic-bio-fonts-81.pages.dev/symbol/sym-1d464/)
- [SYM 1F632](https://matrix-hacker-text-52.pages.dev/symbol/sym-1f632/)
- [SYM 26CA](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-26ca/)
- [SYM 1F629](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1f629/)
- [SYM 1F921](https://clean-dot-aesthetic-48.pages.dev/symbol/sym-1f921/)
- [SYM 1D4A4](https://minimal-star-symbols-93.pages.dev/symbol/sym-1d4a4/)
- [SYM 1F627](https://aesthetic-spacing-fonts-10.pages.dev/symbol/sym-1f627/)
- [SYM 1D438](https://pearl-girly-fonts-86.pages.dev/symbol/sym-1d438/)
- [SYM 262F](https://cyber-clan-tags-90.pages.dev/symbol/sym-262f/)
- [BEAMED SIXTEENTH MUSICAL NOTES](https://pastel-manga-symbols-57.pages.dev/symbol/beamed-sixteenth-musical-notes/)
